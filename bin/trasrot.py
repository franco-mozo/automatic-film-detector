...
def main(film_number):
    ...
    for file in files:
        ...
        alined_frame = rotate_n_translate(frame, corn_matrix, tmp_oriented_corners, ang_tmp)     # roto y translado

        cv2.imwrite('./imagenes/' + carpeta + '/movie/' + file, alined_frame)   # escribo a memoria
