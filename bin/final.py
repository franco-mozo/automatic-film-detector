...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 21 17:40:57 2019
...
def user_requeriments():
    
    carpeta = input('Ingrese nombre de la carpeta que contiene el film: ')
    fps = int(input('Ingrese número de fps: '))
...
#    for file in files[0:10]:
    ...
    if (superiores == []) or (inferiores == []) or (derechos == []):
        ...
        superior, inferior, izquierdo, derecho = ingress_limits(frame)
    else:
